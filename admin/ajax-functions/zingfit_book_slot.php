...
function zingfit_book_slot()
{
    ...
    if(isset($bookSpot->error) && $bookSpot->code != '200'){
        ...
        $customErrorMsgs = [
            'NO_SERIES' => 'You need to purchase a series in order to reserve a mat, <a href="/purchase/">click here</a>.',
            ...
            'SERIES_LIMIT' => 'You need to purchase a series in order to reserve a mat, <a href="/purchase/">click here</a>.',
